  ...
  topStories: [
    {
      ...
      headline: "Sapphire integration moves from lab thesis to packaging bottleneck",
      ...
      tags: ["SEMICONDUCTORS", "RF SYSTEMS", "TRL 4-5"],
      time: "4h ago",
      confidence: "Moderate",
      sourceCount: 14
    },
    {
      ...
      sector: "Energy",
      headline: "Industrial thermal hardware enters the public diligence window",
    ...
    },
    {
      ...
      sector: "Robotics",
      headline: "Autonomous inspection is shifting toward reliability evidence",
      dek: "Robotics buyers are rewarding systems that can survive field constraints, not merely demonstrations that look persuasive in controlled environments.",
      analyst: "Sable Okoro",
      href: "/article/latticearc-robotics",
      tags: ["ROBOTICS", "INFRASTRUCTURE", "DEFENSE"],
      time: "6h ago",
      confidence: "Moderate",
      sourceCount: 16
    },
    {
      id: "top-battery-free-sensing",
      entityName: "Battery-free sensing",
      sector: "Sensors",
      headline: "Passive sensing starts to matter for infrastructure visibility",
      dek: "Energy-harvesting sensing nodes could reduce maintenance drag across utility, industrial, and defense-adjacent environments.",
      analyst: "Lena Marr",
      href: "/patents",
      tags: ["SENSORS", "INFRASTRUCTURE", "PUBLIC SIGNAL"],
      time: "7h ago",
      confidence: "Moderate",
      sourceCount: 11
    },
    {
      ...
      entityName: "Orbital optical communications",
      sector: "Space",
      headline: "Cislunar optics needs a more serviceable supply chain",
      ...
      analyst: "Orin Cross",
      href: "/sector/space",
      tags: ["SPACE", "PHOTONICS", "INFRASTRUCTURE"],
      time: "8h ago",
      confidence: "Moderate",
      sourceCount: 12
    }
